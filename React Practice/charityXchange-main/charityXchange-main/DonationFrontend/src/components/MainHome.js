    ...
    <>
      ...
      <Container className="bg-light text-center mt-0 p-3 rounded">
        <h1 className="display-4 text-primary mb-4 font-weight-bold">
          MyBit: NGO Donation Donation Platform
        </h1>
        <p className="lead" >
            ...
            <Col lg={4}>
              <Card className="border-0 shadow-lg rounded-lg " style={{ height: 755 }} >
                <div className="p-3 bg-primary text-white">
                  <h3 className="text-center mb-0">Monetary Needs</h3>
                </div>
                <Card.Body className="text-center">
                  ...
                  By donating, you can directly support programs and initiatives focused on
                  improving access to nutritious food, implementing sustainable agricultural
                  practices, and providing education and resources to those in need.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
